...
<template>
  <div
    ...
    @click="onClick">
    <div class="picker__mask" :style="pickerMaskStyle"/>
    <div class="picker__indicator" ref="indicator" :style="pickerIndicatorStyle"/>
    <div class="picker__content" :style="wrapperStyle">
      <div
        class="picker__item"
        :class="{ 'picker__item_disabled': isDisabled(option) }"
